...
{{-- <div x-data="{ open: true }" x-show="open" x-transition.duration.300ms @if ($closeSelf> 0) x-init="setTimeout(() =>
  open = false, {{ $closeSelf }})" @endif
  class="flex items-center p-4 mb-4 fixed top-24 right-4 {{ $typeClasses }} rounded-lg" role="alert">
  <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
  </svg>
...
{{-- <div x-data="{ open: true }" x-show="open" x-transition.duration.300ms @if ($closeSelf> 0)
  ...
  <div
    class="flex flex-wrap items-center justify-center w-full max-w-sm space-x-5 shadow-[0.8rem_1rem_0.5rem_rgba(0,0,0,0.1)]">
    <!-- Component Start -->
...
{{-- <div class="relative text-sm font-medium leading-6">
  <div class="absolute -top-14 right-0 w-full max-w-sm shadow-[0.8rem_1rem_0.5rem_rgba(0,0,0,0.1)] bg-white rounded-lg">
    ...
    <div class="flex items-center justify-between p-2">
      ...
      <!-- Icono de cerrar -->
      <div class="close">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-7 rounded cursor-pointer feather feather-x" iewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
