<x-app-layout>
          ...
          <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="px-4 py-5 mx-auto text-center max-w-7xl sm:px-6 lg:py-2 lg:px-8">
              <h2 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-50 sm:text-4xl">
                <span class="block">
                  <a href="https://dev.to/themesberg/open-source-datatable-components-built-wiht-tailwind-css-5fae" target="_blank">DataTables Flowbite</a>
                </span>
              </h2>
            </div>
          </div>
  ...
  @push('scripts')
    <script>
      let dataTable = new DataTable("#dtFlowbite", {
        searchable: false,
        fixedHeight: true,
      });
      // let myTable = document.querySelector("#dtFlowbite");

      /* if (document.getElementById("dtFlowbite") && typeof simpleDatatables.DataTable !== 'undefined') {
    const dataTable = new simpleDatatables.DataTable("#dtFlowbite", {
        searchable: false,
        perPageSelect: false
    });
} */
